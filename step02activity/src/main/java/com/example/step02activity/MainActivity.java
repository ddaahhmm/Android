...
//App이 처음 활성화 될때 사용자를 대면하는 Activity
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* 부모의 메소드 .setContentView() 메소드 호출하면서 어떤 xml 문서를 전개해서 화면을 구성할지 정보를 전달함
        R 은 res
        layout은 layout 폴더
    ...
    public void add(View v){
        ...
        //id가 myCount인 TextView 객체의 참조값 얻어오기 (CharSequence = String)
